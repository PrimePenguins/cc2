...
execute unless items entity @s enderchest.22 gray_stained_glass_pane run scoreboard players set @s enderchest.page 0

execute unless items entity @s enderchest.12 white_dye run function enderchest:selection/movement/rocket
execute unless items entity @s enderchest.13 white_dye run function enderchest:selection/movement/platform
execute unless items entity @s enderchest.14 white_dye run function enderchest:selection/movement/teleport

$item replace entity @s enderchest.12 with white_dye[lore=[[{"bold":false,"color":"dark_gray","italic":false,"translate":"rocket.wand.description"}],{"bold":false,"color":"gray","italic":false,"translate":"rocket.wand.movement"},{"bold":false,"italic":false,"color":"gray","text":""},[{"bold":false,"color":"blue","italic":false,"text":"Costs:"},{"bold":false,"color":"blue","italic":false,"text":" $(rocket)"}]],custom_data={id:"rocket"},item_name={"bold":false,"color":"dark_gray","italic":true,"translate":"rocket.wand.name"},item_model="cc2:wands/rocket"]
$item replace entity @s enderchest.13 with white_dye[lore=[[{"bold":false,"color":"dark_gray","italic":false,"translate":"platform.wand.description"}],{"bold":false,"color":"gray","italic":false,"text":""},{"bold":false,"italic":false,"color":"gray","text":""},[{"bold":false,"color":"blue","italic":false,"text":"Costs:"},{"bold":false,"color":"blue","italic":false,"text":" $(platform)"}]],custom_data={id:"platform"},item_name={"bold":false,"color":"#c135b3","italic":true,"translate":"platform.wand.name"},item_model="cc2:wands/platform"]
$item replace entity @s enderchest.14 with white_dye[lore=[[{"bold":false,"color":"dark_gray","italic":false,"translate":"teleport.wand.description"}],{"bold":false,"color":"gray","italic":false,"translate":"teleport.wand.movement"},{"bold":false,"italic":false,"color":"gray","text":""},[{"bold":false,"color":"blue","italic":false,"text":"Costs:"},{"bold":false,"color":"blue","italic":false,"text":" $(teleport)"}]],custom_data={id:"teleport"},item_name={"bold":false,"color":"#8a55e5","italic":true,"translate":"teleport.wand.name"},item_model="cc2:wands/teleport"]

item replace entity @s enderchest.22 with gray_stained_glass_pane[item_model="cc2:gui/back",custom_name={"translate":"enderchest.menu.back",color:"dark_green"}]
