...
# SELECT THE WANDS
execute unless items entity @s enderchest.11 white_dye run function enderchest:selection/explosive/tnt
execute unless items entity @s enderchest.12 white_dye run function enderchest:selection/explosive/bomb
execute unless items entity @s enderchest.13 white_dye run function enderchest:selection/explosive/seeking
execute unless items entity @s enderchest.14 white_dye run function enderchest:selection/explosive/fireball

# Replace items with wands models
$item replace entity @s enderchest.11 with white_dye[lore=[[{"bold":false,"color":"dark_gray","italic":false,"translate":"tnt.wand.description"}],{"bold":false,"color":"gray","italic":false,"translate":"tnt.wand.explosion"},{"bold":false,"italic":false,"color":"gray","translate":"tnt.wand.distance"},[{"bold":false,"color":"blue","italic":false,"text":"Costs:"},{"bold":false,"color":"blue","italic":false,"text":" $(tnt)"}]],item_name={"bold":false,"color":"dark_red","italic":true,"translate":"tnt.wand.name"},item_model="cc2:wands/tnt"]
$item replace entity @s enderchest.12 with white_dye[lore=[[{"bold":false,"color":"dark_gray","italic":false,"translate":"bomb.wand.description"}],{"bold":false,"color":"gray","italic":false,"translate":"bomb.wand.explosion"},{"bold":false,"italic":false,"color":"gray","translate":"bomb.wand.distance"},[{"bold":false,"color":"blue","italic":false,"text":"Costs:"},{"bold":false,"color":"blue","italic":false,"text":" $(bomb)"}]],custom_data={id:"bomb"},item_name={"bold":false,"color":"gray","italic":true,"translate":"bomb.wand.name"},item_model="cc2:wands/bomb"]
$item replace entity @s enderchest.13 with white_dye[lore=[[{"bold":false,"color":"dark_gray","italic":false,"translate":"seeking.wand.description"}],{"bold":false,"color":"gray","italic":false,"translate":"seeking.wand.shift_desc"},{"bold":false,"color":"gray","italic":false,"translate":"seeking.wand.explosion"},{"bold":false,"italic":false,"color":"gray","translate":"seeking.wand.distance"},[{"bold":false,"color":"blue","italic":false,"text":"Costs:"},{"bold":false,"color":"blue","italic":false,"text":" $(seeking)"}]],custom_data={id:"seeking"},item_name={"bold":false,"color":"blue","italic":true,"translate":"seeking.wand.name"},item_model="cc2:wands/seeking"]
$item replace entity @s enderchest.14 with white_dye[lore=[[{"bold":false,"color":"dark_gray","italic":false,"translate":"fireball.wand.description"}],{"bold":false,"color":"gray","italic":false,"translate":"fireball.wand.explosion"},[{"bold":false,"color":"blue","italic":false,"text":"Costs:"},{"bold":false,"color":"blue","italic":false,"text":" $(fireball)"}]],custom_data={id:"fireball"},item_name={"bold":false,"color":"red","italic":true,"translate":"fireball.wand.name"},item_model="cc2:wands/fireball"]
