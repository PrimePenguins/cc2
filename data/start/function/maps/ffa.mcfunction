...
execute if score $map setting matches 3 run clone 10013 43 17 10087 96 -57 -36 43 200
execute if score $map setting matches 4 run clone 10013 43 -69 10087 96 -143 -36 43 200
