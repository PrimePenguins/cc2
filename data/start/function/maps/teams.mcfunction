...
execute if score $map setting matches 3 run clone 9963 43 18 10001 87 -56 -17 43 200
execute if score $map setting matches 4 run clone 9963 43 -69 10001 87 -143 -17 43 200
