...
execute at @s if items entity @s weapon.mainhand carrot_on_a_stick[custom_data~{id:"dash"}] if score @s mana >= $dash_cost mana.cost run function wands:abilities/dash
# off hand
# Explosive Wands
