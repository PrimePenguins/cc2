...
# Explosive Wands
execute if items entity @s weapon.mainhand carrot_on_a_stick[custom_data~{id:"tnt"}] if score @s mana >= $tnt_cost mana run function wands:raycast/tnt/start_ray
...
# off hand
# Explosive Wands
execute if items entity @s weapon.offhand carrot_on_a_stick[custom_data~{id:"tnt"}] if score @s mana >= $tnt_cost mana run function wands:raycast/tnt/start_ray
