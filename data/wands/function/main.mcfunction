...
execute at @s if items entity @s weapon.offhand carrot_on_a_stick[custom_data~{id:"seeking"}] if score @s mana >= $seeking_cost mana.cost at @s run function wands:abilities/seeking
execute at @s if items entity @s weapon.offhand carrot_on_a_stick[custom_data~{id:"fireball"}] if score @s mana >= $fireball_cost mana.cost at @s run function wands:abilities/fireball
