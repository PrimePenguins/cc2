...
execute if score $border_timer setting matches ..5999 run scoreboard players set $border_timer setting 36000
execute if score $border_timer setting matches 36001.. run scoreboard players set $border_timer setting 6000
