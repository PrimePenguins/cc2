...
execute as @a[gamemode=!spectator] if score $mana.cooldown mana matches ..0 run function game:mechanics/mana/add
# Action bar for mana
execute as @a[gamemode=!spectator] run function game:mechanics/mana/action_bar
