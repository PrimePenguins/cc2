...
execute if score $event main matches 5 run function game:mechanics/events/setup/high_gravity
execute if score $event main matches 6 run function game:mechanics/events/setup/floor_is_explosive
