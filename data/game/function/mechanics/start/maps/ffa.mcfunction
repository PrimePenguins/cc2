...
execute if score $map setting matches 0 run advancement grant @a only cc2:map/map_explorer nether_ffa
execute if score $map setting matches 1 run advancement grant @a only cc2:map/map_explorer classic_ffa
execute if score $map setting matches 3 run advancement grant @a only cc2:map/map_explorer winter_ffa 
