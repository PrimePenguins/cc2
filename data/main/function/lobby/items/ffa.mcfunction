execute as @s unless items entity @s hotbar.3 gray_dye run function main:lobby/team_join/playing

execute as @s unless items entity @s hotbar.5 gray_dye run function main:lobby/team_join/spectate
